...
void get_ramp_Te(double *Te, int Nx, double T_start, double T_end, double t, double tfinal);

void PoissNonlin1D(int N, double *source, double dx, double Lx, double *phi, double *Te);

void PoissLin1D(int N, double *source, double dx, double Lx, double *phi, double *Te);

void PoissLin1D_TF(int N, double *source, double dx, double Lx, double *phi, double *Te);

void PoissNonlin1D_TF(int N, double *source, double dx, double Lx, double *phi, double *Te);
